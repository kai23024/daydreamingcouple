...
<template>
  <div class="mx-auto max-w-3xl px-5 py-16">
    <p class="text-xs uppercase tracking-[0.2em] text-amber-700">About Us</p>
    <h1 class="mt-2 font-serif text-3xl text-stone-800">關於我們</h1>
    ...
    <div class="mt-8 space-y-5 leading-relaxed text-stone-600">
      ...
      <p>
        白日夢情侶檔記錄的不只是景點，更是旅途中那些微小卻珍貴的瞬間——一杯剛好的咖啡、一場突如其來的雨、
        一段只屬於我們兩人的對話。希望這裡分享的照片與文字，也能成為你規劃下一趟旅行時的一點靈感。
      </p>
      <p>謝謝你路過我們的白日夢。</p>
    </div>

    <div class="mt-10 rounded-lg bg-stone-100 p-6 text-sm text-stone-500">
      <p class="font-medium text-stone-700">聯絡方式</p>
