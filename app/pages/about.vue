...
<template>
  <div class="mx-auto max-w-3xl px-5 py-16">
    <h1 class="text-3xl text-morandi-900">關於．我們US</h1>
    ...
    <div class="mt-8 space-y-5 leading-relaxed text-morandi-700">
      ...
      <p>
        一個極度熱愛攝影、一個專精尋找隱藏版美食，組成了這個默契十足的神奇組合。我們致力於走訪不同的城市與國家，解鎖各種新奇、獨特、甚至是有些怪異的在地體驗。就算過程中偶爾狼狽、有點辛苦，甚至伴隨著不適，但對我們來說，這些意料之外的冒險都是無可取代的養分，也讓我們在一次次探索中，看見更好的自己。
      </p>
      <p>
