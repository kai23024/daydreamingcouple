...
<template>
  <div class="mx-auto max-w-3xl px-5 py-16">
    ...
    <div class="mt-8 space-y-5 leading-relaxed text-morandi-700">
      ...
      <h2 class="mt-8 font-serif text-xl font-bold text-morandi-900">我們的網站特色：不只是遊記，更是你的旅程神對手！</h2>
      <ul class="space-y-3">
      ...
      <h2 class="mt-8 font-serif text-xl font-bold text-morandi-900">合作成就與品牌歷程</h2>
